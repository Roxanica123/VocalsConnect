...
\section{Încărcarea întregului set de date în memorie}
...
mai este încărcat în totalitate în memorie. Când se folosește această abordare pipeline-ul primește un obiect al clasei \textit{File Names
...
memorie și le returnau pe rând utilizând \textit{tensorflow.data.Dataset}. În acest mod, a fost rezolvată problema spațiului, menționată anterior,
...
\pagebreak
\section{Experimente}
Statisticile legate de timpul de antrenare al rețelei au fost obținute utilizând Tensorboard \footnote{\url{https://www.tensorflow.org/tensorboard}}. Comparațiile au fost făcute pentru \textit{tensorflow.data.Dataset}
