...
ce au la bază straturi convoluționale precum ResNet-50 \cite{resnet} și AlexNet \cite{alexnet} au rezultate mai bune în comparație 
...
spectrograme, cu cele ale algoritmilor SVM care primesc ca input caracteristici extrase manual din semnalul audio și apoi s-a încercat 
combinarea acestora.
...
reprezentări de dimensiuni mai mari ale semnalelor audio precum spectograme sau coeficienți MFCC.